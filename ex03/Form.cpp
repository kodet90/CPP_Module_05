...
Form::ExecuteRequirementException::ExecuteRequirementException() {
}

Form::ExecuteRequirementException::ExecuteRequirementException(
ExecuteRequirementException const & ExecuteRequirementException) {
	*this = ExecuteRequirementException;
}

Form::ExecuteRequirementException::~ExecuteRequirementException() throw() {
}

Form::ExecuteRequirementException &	Form::ExecuteRequirementException::operator=(
ExecuteRequirementException const & ExecuteRequirementException) {
	static_cast<void>(ExecuteRequirementException);
	return *this;
}

char const * Form::ExecuteRequirementException::what() const throw() {
	return "Exception: Execute requirements not met";
}
...
void	Form::beExecuted(const Bureaucrat & bureaucrat) const {
	if (!this->_signed || this->_gradeExecute < bureaucrat.getGrade()) {
		throw Form::ExecuteRequirementException();
	}
}
